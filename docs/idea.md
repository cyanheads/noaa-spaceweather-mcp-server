...
- **Interpretation is the value.** Raw Kp/Bz/flux numbers are opaque. Tools should attach the NOAA scale and a plain-language read ("Kp 6 — G2 moderate storm; aurora possible to ~55° geomagnetic latitude"), not just the number.
